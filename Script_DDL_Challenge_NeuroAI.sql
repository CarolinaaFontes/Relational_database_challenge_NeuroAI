...
-- ALTERANDO TABELAS 
ALTER TABLE T_HC_ENDERECO ADD ID_PACIENTE CHAR(5);
ALTER TABLE T_HC_TELEFONE ADD ID_PACIENTE CHAR(5);
ALTER TABLE T_HC_LEMBRETE ADD ID_PACIENTE CHAR(5);
ALTER TABLE T_HC_CONSULTA ADD ID_PACIENTE CHAR(5);
ALTER TABLE T_HC_CONSULTA ADD ID_MEDICO CHAR(5);
ALTER TABLE T_HC_CONSULTA ADD ID_CONEXAO CHAR(5);
...
ALTER TABLE T_HC_TELEFONE ADD CONSTRAINT UN_TELEDONE_NUMERO UNIQUE (NR_TELEFONE);
...
ALTER TABLE T_HC_TELEFONE MODIFY (NR_TELEFONE CONSTRAINT CK_NR_TELEFONE NOT NULL);
